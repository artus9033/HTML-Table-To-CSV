...
JHTCSVWorker.prototype.exportToCSV = function(splicePos, spliceLength, selector, excludedColumns, lastCol, minusSubstitute, hasHeader){
	var arr = new Array();
	var mCt = 0;
	var klucz = 0;
	var delimiterKolumn = ",";
	if(hasHeader == true){
		$(selector + ' thead').children().each(function(){
